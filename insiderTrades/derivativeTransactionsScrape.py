...
def derivativeTransactionsScrape(index, form, name, email, transactionType = None, footnoteKeywords = None, issuerKeywords = None, issuerTradingSymbol = None, rptOwnerKeywords = None):
    """
