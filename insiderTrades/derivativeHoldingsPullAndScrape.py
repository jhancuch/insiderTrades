...
def derivativeHoldingsPullAndScrape(quarter, year, form, name, email, footnoteKeywords = None, issuerKeywords = None, issuerTradingSymbol = None, rptOwnerKeywords = None):
    """
