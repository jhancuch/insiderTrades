...
def transactionFilterDerivativeHoldings(filing, footnoteKeywords = None, issuerKeywords = None, issuerTradingSymbol = None, rptOwnerKeywords = None):
    """
    ...
    if footnoteKeywords is not None:
        ...
        filingTransactionSection = re.search(r'<derivativeHolding>.*?</derivativeHolding>', filing, flags = re.MULTILINE | re.DOTALL)[0]
