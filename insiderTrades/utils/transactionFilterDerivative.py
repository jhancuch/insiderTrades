...
def transactionFilterDerivative(filing, footnoteKeywords = None, issuerKeywords = None, issuerTradingSymbol = None, rptOwnerKeywords = None, transactionType = None):
    """
    ...
    if footnoteKeywords is not None:
        ...
        filingTransactionSection = re.search(r'<derivativeTransaction>.*?</derivativeTransaction>', filing, flags = re.MULTILINE | re.DOTALL)[0]
    ...
    if transactionType is not None:
        ...
        transactionTypeSection = re.search('<derivativeTransaction>.*?</derivativeTransaction>', filing, flags = re.MULTILINE | re.DOTALL)[0]
