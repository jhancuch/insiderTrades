...
def formFilterDerivativeTransactions(filing, footnoteKeywords = None, issuerKeywords = None, issuerTradingSymbol = None, rptOwnerKeywords = None, transactionType = None):
    """
    ...
    if transactionType is not None:
        ...
        transactionTypeSection = re.search('<derivativeTable>.*?</derivativeTable>', filing, flags = re.MULTILINE | re.DOTALL)[0]
